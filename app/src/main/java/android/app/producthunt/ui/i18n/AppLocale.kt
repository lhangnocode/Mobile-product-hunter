...
data class AppStrings(
    ...
    val aiAgent: String,
    val aiMode: String,
    val aiModeAgentApi: String,
    val aiModeOnDevice: String,
    ...
    val wishlistAdded: String,
    val wishlistRemoved: String,
    val wishlistRemovedMany: (Int) -> String,
    val priceAlertSaveSuccess: String,
    val priceAlertRemoved: String,
    ...
    companion object {
        val en = AppStrings(
            ...
            aiAgent = "AI Agent",
            aiMode = "AI mode",
            aiModeAgentApi = "AI via Agent API",
            aiModeOnDevice = "On-device AI",
            ...
            wishlistRemovedMany = { count -> "Removed $count wishlist items" },
        ...
        val vi = AppStrings(
            ...
            aiAgent = "Trợ lý AI",
            aiMode = "Chế độ AI",
            aiModeAgentApi = "AI qua Agent API",
            aiModeOnDevice = "AI trên thiết bị",
            ...
            wishlistAdded = "Đã thêm vào danh sách yêu thích",
            wishlistRemoved = "Đã xóa khỏi danh sách yêu thích",
            wishlistRemovedMany = { count -> "Đã xóa $count sản phẩm yêu thích" },
            priceAlertSaveSuccess = "Đã lưu cảnh báo giá",
            priceAlertRemoved = "Đã xóa cảnh báo giá",
